...
function Element:New(Config)
    ...
    Dropdown.UIElements.SearchFrame = New("Frame", {
        ...
        New("Frame", {
            ...
            New("ImageLabel", {
                Image = "rbxasset://textures/ui/GuiImagePlaceholder.png", -- fallback if Creator.Icon fails
                Size = UDim2.new(0, 16, 0, 16),
    ...
    Dropdown.UIElements.SearchInput = Dropdown.UIElements.SearchFrame.Frame.SearchInput
